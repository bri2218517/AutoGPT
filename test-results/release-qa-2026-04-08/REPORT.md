...
![500 error on save](retest-13-save-500-error.png){ width=80% }
...
![Blocks on canvas before save attempt](retest-06-four-blocks.png){ width=80% }

![Run completed — all nodes green](retest-20-run-completed.png){ width=80% }

![Schedule created](retest-23-schedule-created.png){ width=80% }

![Export from More Actions](retest-38-agent-exported.png){ width=80% }

![Task completed in Library runner](retest-36-task-completed.png){ width=80% }
...
![Forgot password form](auth-03-forgot-password-page.png){ width=70% }

![Signup page](auth-05-signup-page.png){ width=70% }

![Tutorial welcome dialog](auth-07-tutorial-welcome.png){ width=70% }
...
![Profile display name saved](settings-02-profile-persisted.png){ width=80% }

![Notifications toggle saved](settings-13-notifications-on-saved.png){ width=70% }
...
![Agent submitted to marketplace — Awaiting review](mkt-01-submit-pending.png){ width=80% }

![Agent approved — visible in marketplace](mkt-02-approved-confirmation.png){ width=80% }

![Agent run completed post-download](mkt-04-agent-run-completed.png){ width=80% }

![Creator Dashboard — approved agent, no delete](mkt-06d-approved-no-delete.png){ width=70% }
...
![AutoPilot home — prompt pills](ap-01-autopilot-home-clean.png){ width=80% }

![Hello World agent created](ap-06-agent-created.png){ width=80% }

![Web search results with citations](ap-05-web-search-response.png){ width=80% }

![Calculator — correct result](ap-05-calculator-response.png){ width=70% }

![Agent in Library after AutoPilot creation](ap-07-library-hello-world.png){ width=80% }

![Context memory — correct prior message recalled](ap-10-context-memory.png){ width=80% }

![Twitter auth prompt in chat](ap-13-twitter-auth.png){ width=80% }

![File uploaded](ap-14-file-uploaded.png){ width=70% }

![Image described accurately](ap-15-image-described.png){ width=80% }

![Scheduling — 4+ min, no response (BUG)](ap-17-scheduling.png){ width=80% }
